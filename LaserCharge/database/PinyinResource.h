...
public:
    static QMap<QString, QString> getPinyinResource() { return getResource(":/pinyin/database/pinyin.db"); }
    static QMap<QString, QString> getMutilPinyinResource() { return getResource(":/pinyin/database/mutil_pinyin.db"); }
    static QMap<QString, QString> getChineseResource() { return getResource(":/pinyin/database/chinese.db"); }
};
